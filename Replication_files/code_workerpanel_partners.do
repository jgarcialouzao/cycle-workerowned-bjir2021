...
**Merge monthly earnings
  merge m:1 idperson idplant month_wobs using ../mcvl_stata/wages_m20052018.dta, keep(match) keepusing(w)
drop _merge
...
save ../Data/workerpanel_monthly_partners.dta, replace
